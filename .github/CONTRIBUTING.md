...
Before filing, please check existing [open issues](https://github.com/tabpilot/tabpilot/issues) to avoid duplicates.
...
Use [GitHub Discussions](https://github.com/tabpilot/tabpilot/discussions) for questions about usage, self-hosting, configuration, or general discussion. Issues are reserved for actionable bug reports and feature requests.
...
5. **Push your branch** to your fork and [open a pull request](https://github.com/tabpilot/tabpilot/compare) against `master`.
