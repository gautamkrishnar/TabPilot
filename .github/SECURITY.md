...
1. **GitHub Private Security Advisory (preferred):** Navigate to the [Security tab](https://github.com/tabpilot/tabpilot/security/advisories/new) of this repository and click "Report a vulnerability". This keeps the disclosure private until a fix is available.
